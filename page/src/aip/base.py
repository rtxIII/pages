...
APP_ID = '20476890'
API_KEY ='FWjAyGDjXgfgxKMj9mUVeil3'
SECRET_KEY = '8GawqtvfZ48IuZvClR8m8DqEItfgQCYg'

BAIDU_NLP_APP_ID = '11307942'
BAIDU_NLP_APP_KEY = 'A0sgOudHqBipVotebf7K1i08'
BAIDU_NLP_SECRET_KEY = 'EYG0CjQofDrtPb5VcA8lgWCu1dUTWLoW'
...
class AipBase(object):
    ...
    def __init__(self, appId=APP_ID, apiKey=API_KEY, secretKey=SECRET_KEY):
        """
